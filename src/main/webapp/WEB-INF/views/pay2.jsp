					...
					<div class="destination_wrap">
						<div class="deliver_wrap _deliveryInfos _deliveryInfoType">
							...
							<ul class="addr_list _deliveryPlaces _deliveryPlaces_0">
								<td><li>배송지명&emsp;&emsp;&emsp;<input type="text"
										size=25></li></td>
								<br />
								<td><li>수령인&emsp;&emsp;&emsp;&emsp;<input type="text"
										size=25></li></td>
								<br />
								<td><li>연락처&emsp;&emsp;&emsp;&nbsp;&nbsp; <select
										size="1">
										...
										type="text" size=10></li></td>
								<br />
								<td><li>배송지&emsp;&emsp;&emsp;&emsp;<input type="text"
										size="10">&nbsp;<input type="button" value="우편번호"></li></td>
								<br /> &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&nbsp;&nbsp;
								<input type="text" size="35">
								<td><li>배송메모&emsp;&emsp;&emsp;<input type="text"
										size=45></li></td>
								<br />
							</ul>
						</div>
								...
								<div class="header tooltip_area">
									<span class="ajax_radio radio-applied _payMethodRadio">
										...
										class="radio-mark _radioMarker _click(nmp.front.order.order_sheet.changePaymentTab(naverPaymentsBank)) _stopDefault"></span>
										 <input type="radio"
										name="payMethod" value="naverPaymentsBank"
							...
							<li class="paymethod _payMethodTab _naverPaymentsCardTab">
								<div class="header">
									<span class="ajax_radio radio-applied _payMethodRadio">
										...
										value="naverPaymentsCard" id="naverPaymentsCardRadio"
										checked="checked"
										...
										<input type="radio"
										value="naverPaymentsCard" id="naverPaymentsCardCheckBox"
										class="_click(nmp.front.order.order_sheet.changePaymentTab(naverPaymentsCard)) _stopDefault">
									</span> <label for="naverPaymentsCardRadio">카드 간편결제</label>
...
<div class="payment_agree_wrap">
<button onclick="javascript:btn('결제가 완료되었습니다.' )"> 결제하기 </button> <br> 
</div>
...
<!-- 					<div class="ly_wrap _adultAuthentication" -->
<!-- 						style="margin-left: -240px;"> -->
<!-- 						<div class="ly_container adult_certify"> -->
<!-- 							<strong class="ly_tit">알려드립니다.</strong> -->
<!-- 							<p class="ly_desc"> -->
<!-- 								주류 상품 구매 시 관계법령에 따라 개인정보 제공 동의 및<br> <em -->
<!-- 									class="point_txt_red">19세 이상 본인인증</em>을 거쳐야 구매하실 수 있습니다. -->
<!-- 							</p> -->
<!-- 							<div class="area_btn"> -->
<!-- 								<a href="#" -->
<!-- 									class="btn_prev type_green _click(nmp.front.order.order_sheet.openAdultAuthenticationPopup(PC_PHONE)) _stopDefault">휴대폰 -->
<!-- 									인증</a> <a href="#" -->
<!-- 									class="btn_prev type_green _click(nmp.front.order.order_sheet.openAdultAuthenticationPopup(IPIN)) _stopDefault">아이핀 -->
<!-- 									인증</a> <a href="#" -->
<!-- 									class="btn_prev _click(nmp.front.order.order_sheet.hideAdultAuthenticationLayer(true)) _stopDefault">취소</a> -->
<!-- 							</div> -->
<!-- 						</div> -->
<!-- 					</div> -->
<!-- 				</div> -->
				...
				<!--  수정 불가(IFRAME 방식시 사용)   -->
				<div id="LGD_PAYMENTWINDOW"
					style="position: absolute; display: none; left: 0; top: 0; width: 100%; height: 100%; background-color: white; z-index: 100; font-size: small;">
					<iframe id="LGD_PAYMENTWINDOW_IFRAME"
						name="LGD_PAYMENTWINDOW_IFRAME" height="100%" width="100%"
						scrolling="auto" frameborder="0" style="background-color: white;"
						title="내용없음"> </iframe>
				</div>
				<div id="INI_PAYMENTWINDOW"
					style="position: absolute; display: none; left: 0; top: 0; width: 100%; height: 100%; background-color: white; z-index: 100; font-size: small;">
					<iframe id="INI_PAYMENTWINDOW_IFRAME"
						name="INI_PAYMENTWINDOW_IFRAME" height="100%" width="100%"
						scrolling="no" frameborder="0" style="background-color: white;"
						title="내용없음"> </iframe>
				</div>
				<script type="text/javascript" language="JavaScript"
					src="https://ssl.pstatic.net/static.checkout/layout/202211161500/js/customer/layout.variable.real.js"></script>
				<script type="text/javascript" language="JavaScript"
					src="https://ssl.pstatic.net/static.checkout/layout/202211161500/js/customer/layout.gnb.js"></script>
				<script type="text/javascript" language="JavaScript"
					src="https://ssl.pstatic.net/static.checkout/layout/202211161500/js/customer/layout.lnb.js"></script>
				<script type="text/javascript" language="JavaScript"
					src="https://ssl.pstatic.net/static.checkout/layout/202211161500/js/customer/checkout.nclktag.js"></script>
</body>
</html>
