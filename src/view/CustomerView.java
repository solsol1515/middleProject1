...
public class CustomerView extends JPanel 
{
	...
	public void registCustomer(){
		...
		String name = tfCustName.getText();			// 이름 저장
		String tel1 = tfCustTel.getText();			// 전화번호 저장
		String tel2 = tfCustTelAid.getText();		// 추가 전화번호 저장
		String addr = tfCustAddr.getText();			// 주소 저장
		String email = tfCustEmail.getText();		// 메일 저장
		
		// 2. 1의 값들을 Customer 클래스의 멤버로지정
		// 값 지정 (1) setter (2) constructor
		// (1)
		// CustomerVO vo = new CustomerVO(name, tel1, tel2, addr, email);
